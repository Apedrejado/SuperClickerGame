...
import { SparklesCore } from './sparkcles'
  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-[-60] bg-gradient-to-br from-neutral-300 to-neutral-500 py-2 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl"
      >
        quero 
        <br />cafe
      </motion.h1>
